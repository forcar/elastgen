...
a Monte-Carlo sampling of formula (B.4) and (B.5) from [RMP, Vol. 41, 205 (1969)]. [ECsf](https://github.com/forcar/clas12ana/blob/master/src/main/java/org/clas/analysis/ECsf.java)
